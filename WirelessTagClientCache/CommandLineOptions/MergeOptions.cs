...
{
    [Verb("merge", isDefault: false, HelpText = "Merge new measurements with historic measurements in the cache")]
    public class MergeOptions
    {
        ...
        [Option("to", Required = false, HelpText = "End date (yyyy-MM-dd).")]
        public DateTime To { get; set; } // = DateTime.Parse("2025-12-01");
